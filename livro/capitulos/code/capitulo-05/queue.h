...
/**
 * Retorna o elemento na cabeça da fila sem removê-lo. Tem complexidade O(1)
 */
...
/**
 * Retorna 1 se a fila estiver vazia e 0 caso contrário. Tem complexidade O(1)
 */
int isEmpty(Queue *queue);

/**
 * Retorna 1 se a fila estiver completa e 0 caso contrário. Tem complexidade O(1)
 */
